...
from evoquant.translator_engine.jinja_template import TemplateEngine, CTraderJinjaTranslator
...
class TestTemplateEngine:
    ...
    def test_save_rendered_code(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            filepath = engine.save_rendered_code(
                rendered_code,
                tmpdir,
                prefix="test",
                extension="py"
...
class TestCTraderJinjaTranslator:
    ...
    def test_init_custom_params(self):
        ...
        translator = CTraderJinjaTranslator(
            indicator_signal_code="test_code",
    ...
    def test_generate_code_structure(self):
        ...
        translator = CTraderJinjaTranslator(
            indicator_signal_code="// Indicator code here",
            strategy_params={"strategy_name": "TestBot"}
        )
    ...
    def test_generate_code_with_all_params(self):
        ...
        translator = CTraderJinjaTranslator(
            indicator_signal_code="// Entry logic",
...
bool signal = sma > rsi;"""
        ...
        translator = CTraderJinjaTranslator(
            indicator_signal_code=indicator_code,
            strategy_params={"strategy_name": "IndentTest"}
        )
...
class TestTemplateIntegration:
    ...
    def test_multiple_translations_same_engine(self):
        ...
        translator = CTraderJinjaTranslator(
            indicator_signal_code="base_code",
            strategy_params={"strategy_name": "Base"}
        )
...
class TestTemplateProperties:
    ...
    def test_template_always_produces_valid_csharp_namespace(self):
        ...
        translator = CTraderJinjaTranslator(
            indicator_signal_code="test",
            strategy_params={"strategy_name": "NamespaceTest"}
        )
    ...
    def test_template_handles_boolean_values_correctly(self):
        ...
        for python_bool, csharp_bool in test_cases:
            translator = CTraderJinjaTranslator(
                indicator_signal_code="test",
                strategy_params={"exit_encoded_entry": python_bool}
            )
    ...
    def test_template_preserves_code_blocks(self):
        ...
        translator = CTraderJinjaTranslator(
            indicator_signal_code=multi_line_code
        )
