...
namespace cAlgo.Robots
{
    ...
    {
        [Parameter(DefaultValue = "TestBot")]
        ...
        {   
            ...
            TradeSize = 50; //TODO: TradeSize need to be given as Valid Double and converted to volume/units (not lots).
            ...
            Print("Estimated Margin for Long with 50 units = {0}", Symbol.GetEstimatedMargin(TradeType.Buy, 50));
        ...
        {   
            ...
            // Simple Signals
            var signal0 = SeriesCrossAboveSeries(Low, Indicators.GetIndicator<Shift>(Low, 7).Result);
            var signal1 = IsIncr(Open, 5);
            var signal2 = SeriesIsBelowSeries(Low, Indicators.GetIndicator<Shift>(Low, 5).Result);
            var signal3 = SeriesCrossBelowSeries(High, Indicators.GetIndicator<Shift>(High, 21).Result);
            // Composite Signals
            var signal4 = (signal0 | signal1) & (signal2 | signal3);
            // Root Signal
            var root_signal = signal4;
